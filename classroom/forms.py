...
class StudentProfileForm(forms.ModelForm):
    class Meta():
        model =  Student
        fields = ['name','sem','phone','email']
        widgets = {
                'name': forms.TextInput(attrs={'class':'answer'}),
                'sem': forms.NumberInput(attrs={'class':'answer'}),
                'phone': forms.NumberInput(attrs={'class':'answer'}),
                'email': forms.EmailInput(attrs={'class':'answer'}),
                }
...
class StudentProfileUpdateForm(forms.ModelForm):
    class Meta():
        model = Student
        fields = ['name','sem','email','phone','student_profile_pic']
...
class AssignmentForm(forms.ModelForm):
    class Meta():
        ...
        fields = ['assignment_name','ass_sub','due_date','maxMark','assignment']
        widgets ={
            'due_date':DateInput(),
        }
