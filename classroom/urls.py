...
urlpatterns =[
    ...
    path('studentclass/',views.studentclass,name="studentclass"),
    ...
    # path('student/enter_marks/',views.add_marks,name="enter_marks"),
    ...
    path('assignment_summary/<int:ass_id>/',views.assignment_summary,name="assignment_summary"),
